 ...
 * @param index
 */
export declare function initUpdateIndexReverse<V>(views: BaseReadArray<ModelWriteValue<V>>, index: number): void;
/**
 * 删除时更新计算
 * @param views
 * @param index
 */
export declare function removeUpdateIndexReverse<V>(views: BaseReadArray<ModelWriteValue<V>>, index: number): void;
/**
 * 移动时更新计数
 * @param views
 * @param oldIndex
 * @param newIndex
 */
export declare function moveUpdateIndexReverse<V>(views: BaseReadArray<ModelWriteValue<V>>, oldIndex: number, newIndex: number): void;
 ...
 * @param insert
 */
export declare function modelCacheReverse<T, V>(model: mve.CacheArrayModel<T>, insert: (row: T, index: mve.GValue<number>) => V, destroy?: (v: V) => void): ModelCacheReturn<V>;
 ...
 * @param fun
 */
export declare function modelChildrenReverse<T, EO>(model: mve.CacheArrayModel<T>, fun: RenderModelChildren<T, EOChildren<EO>>): EOChildFun<EO>;
 ...
 * @param fun
 */
export declare function modelCacheChildrenReverse<T, V, EO>(model: mve.CacheArrayModel<T>, fun: RenderModelChildren<T, ModelChildrenRenderReturn<V, EO>>): {
    views: ModelCacheChildren<V>;
    children: EOChildFun<unknown>;
};
